...
public class ListViewUsageAdapter extends BaseAdapter {
    ...
    private List<Usage> listPerson;

    public ListViewUsageAdapter(Activity activity, List<Usage> listPerson){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.textViewFirstName.setText(listPerson.get(position).getUsage());
